...
const Register = () => {
  ...
  const { registerData, updateRegisterData, registerUser, registerError, isRegisterLoading } = useContext(AuthContext)
        ...
        <Row style={{
          ...
          <Col xs={6}>
            <Stack gap={3}>
              ...
              />
              <Button disabled={isRegisterLoading} variant="primary" type="submit">
